...
public final class GetSensitiveFileResult {
    ...
    public static final class Builder {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "content");
            }
        ...
        public Builder contentBase64(String contentBase64) {
            if (contentBase64 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentBase64");
            }
        ...
        public Builder contentBase64sha256(String contentBase64sha256) {
            if (contentBase64sha256 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentBase64sha256");
            }
        ...
        public Builder contentBase64sha512(String contentBase64sha512) {
            if (contentBase64sha512 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentBase64sha512");
            }
        ...
        public Builder contentMd5(String contentMd5) {
            if (contentMd5 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentMd5");
            }
        ...
        public Builder contentSha1(String contentSha1) {
            if (contentSha1 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentSha1");
            }
        ...
        public Builder contentSha256(String contentSha256) {
            if (contentSha256 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentSha256");
            }
        ...
        public Builder contentSha512(String contentSha512) {
            if (contentSha512 == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "contentSha512");
            }
        ...
        public Builder filename(String filename) {
            if (filename == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "filename");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSensitiveFileResult", "id");
            }
            this.id = id;
            return this;
        }
