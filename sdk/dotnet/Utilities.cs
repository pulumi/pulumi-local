...
namespace Pulumi.Local
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Local.version.txt");
    ...
    internal sealed class LocalResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LocalResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
